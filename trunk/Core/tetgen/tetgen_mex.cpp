/*=================================================================
 * tetgen_mex.cpp - matlab interface to tetgen
 *
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    if (nrhs > 4) {
        mexErrMsgIdAndTxt( "MATLAB:tetgen_mex:invalidNumInputs",
    ...
    if (nlhs > 3){
        mexErrMsgIdAndTxt( "MATLAB:tetgen_mex:maxlhs",
    ...
    if (nrhs > VERTS_IDX && mxIsDouble(prhs[VERTS_IDX])) {
        ...
        if (dim != DIM) {
            mexErrMsgIdAndTxt( "MATLAB:tetgen_mex:invalidInput",
                "Vertex array must be of size 3xN.");    
        }
    } else {
        mexErrMsgIdAndTxt( "MATLAB:tetgen_mex:invalidInputType",
    ...
    try {
        ...
        mexErrMsgIdAndTxt( "MATLAB:tetgen_mex:tetgen_error",
